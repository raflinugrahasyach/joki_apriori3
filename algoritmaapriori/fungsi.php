...
function list_users($name, $selected_id = '', $required = false, $all = false, $text_all = '-', $where = '', $params = '')
{
    ...
    echo " class='form-control' " . $params . " >";
    ...
    while ($myrow = $db_obj->db_fetch_array($query)) {
        ...
        if ($selected_id == $myrow['id']) echo "selected='selected'";
...
function list_periode($name, $selected_id = '', $required = false, $all = false, $text_all = '-', $where = '', $params = '')
{
    ...
    //loop data
    while ($myrow = $db_obj->db_fetch_array($query)) {
        echo "<option value='" . $myrow['id_periode'] . "' ";
        if ($selected_id == $myrow['id_periode']) echo "selected='selected'";
...
function list_mata_kuliah($name, $selected_id = '', $required = false, $all = false, $text_all = '-', $where = '', $params = '')
{
    ...
    //loop data
    while ($myrow = $db_obj->db_fetch_array($query)) {
        echo "<option value='" . $myrow['id_mk'] . "' ";
        if ($selected_id == $myrow['id_mk']) echo "selected='selected'";
...
function list_dosen($name, $selected_id = '', $required = false, $all = false, $text_all = '-', $where = '', $params = '')
{
    ...
    //loop data
    while ($myrow = $db_obj->db_fetch_array($query)) {
        echo "<option value='" . $myrow['id_dosen'] . "' ";
        if ($selected_id == $myrow['id_dosen']) echo "selected='selected'";
...
function list_bulan($selected_id)
{
    ...
    if ($selected_id == '01') echo "selected='selected'";
    echo ">Januari</option>";
    echo "	<option value='02' ";
    if ($selected_id == '02') echo "selected='selected'";
    echo ">Februari</option>";
    echo "	<option value='03' ";
    if ($selected_id == '03') echo "selected='selected'";
    echo ">Maret</option>";
    echo "	<option value='04' ";
    if ($selected_id == '04') echo "selected='selected'";
    echo ">April</option>";
    echo "	<option value='05' ";
    if ($selected_id == '05') echo "selected='selected'";
    echo ">Mei</option>";
    echo "	<option value='06' ";
    if ($selected_id == '06') echo "selected='selected'";
    echo ">Juni</option>";
    echo "	<option value='07' ";
    if ($selected_id == '07') echo "selected='selected'";
    echo ">Juli</option>";
    echo "	<option value='08' ";
    if ($selected_id == '08') echo "selected='selected'";
    echo ">Agustus</option>";
    echo "	<option value='09' ";
    if ($selected_id == '09') echo "selected='selected'";
    echo ">September</option>";
    echo "	<option value='10' ";
    if ($selected_id == '10') echo "selected='selected'";
    echo ">Oktober</option>";
    echo "	<option value='11' ";
    if ($selected_id == '11') echo "selected='selected'";
    echo ">November</option>";
    echo "	<option value='12' ";
    if ($selected_id == '12') echo "selected='selected'";
